...
#jawaban
#Cara klasik pakai get_ dan set_ → lebih ribet.
#Cara Pythonic pakai @property → lebih mudah, rapi, dan tetap aman.
#Keuntungan cara Pythonic (@property):
#Lebih sederhana dan mudah digunakan.
#Kode lebih rapi dan terlihat alami.
#Tetap aman karena ada validasi.
#Mudah dirawat atau diubah nantinya.